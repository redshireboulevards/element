...
ROOT_DIR = environ.Path(__file__) - 3  # (element/config/settings/common.py - 3 = element/)
APPS_DIR = ROOT_DIR.path('element')
...
MIGRATION_MODULES = {
    'sites': 'element.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///element'),
}
